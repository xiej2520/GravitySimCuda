...
// shaders
static ID3DBlob *vs_blob_ptr = NULL, *ps_blob_ptr = NULL, *error_blob = NULL;
static ID3D11VertexShader *vertex_shader_ptr = NULL;
static ID3D11PixelShader *pixel_shader_ptr = NULL;
static ID3D11InputLayout* input_layout_ptr   = NULL;
...
int main(int, char**)
{
    ...
    while (!done) {
        ...
        g_pd3dDeviceContext->IASetVertexBuffers(0, 1, &vertex_buffer_ptr, &vertex_stride, &vertex_offset);
        g_pd3dDeviceContext->VSSetShader(vertex_shader_ptr, NULL, 0);
        g_pd3dDeviceContext->PSSetShader(pixel_shader_ptr, NULL, 0);
        g_pd3dDeviceContext->Draw(vertex_count, 0);
